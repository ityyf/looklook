...
<h2 style="color: yellowgreen;font-family: '华文行楷';margin: 5px 0 10px 22%;">请您对我们提出意见</h2>
<form action="{{url('help_add')}}" name="form1" required method="post" enctype="multipart/form-data">
