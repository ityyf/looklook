        ...
        <div class="wrap">
            <ul class="choose_cate">
                ...
                @foreach($type as $key=>$val)
                    <li c_data="27"><i style="background:none;width:10px;margin-right:0;" class="s" ></i><a class='a_type' href="{{url('/')}}?type_id=<?php echo $val['type_id'] ?>"><?php  echo $val['type_name']?></a><i class="e"></i></li>
                @endforeach
            </ul>
            <div class="clear"></div>
        </div>
